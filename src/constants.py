...
DEFAULT_CHANNELS = 2
DEFAULT_TRIM_LONG_SILENCE = True
DEFAULT_SILENCE_TRIM_MODE = 'auto'
...
SILENCE_TRIM_MIN_SILENCE_SEC = 2.5
SILENCE_TRIM_KEEP_SILENCE_SEC = 0.5
SILENCE_TRIM_THRESHOLD_DB = -38
SILENCE_TRIM_MIN_REDUCTION_SEC = 3.0
DEFAULT_SILENCE_TRIM_MIN_SILENCE_SEC = SILENCE_TRIM_MIN_SILENCE_SEC
DEFAULT_SILENCE_TRIM_THRESHOLD_DB = SILENCE_TRIM_THRESHOLD_DB
